// Mock data for the FITAI gym CRM.
...
export type AiCoachStatus = "Awaiting reply" | "Suggestion sent" | "Resolved"
...
export const aiCoachThreads: AiCoachThread[] = [
  {
    id: 1,
    member: "Mike Johnson",
    topic: "Workout reminder",
    lastMessage: "Hey Mike, dont forget your lower-body session at 18:00.",
  ...
  },
  {
    id: 2,
    member: "Sarah Miller",
    topic: "Weekly motivation",
    lastMessage: "Amazing progress this week - your bench is up 5kg!",
    status: "Resolved",
    time: "11:15",
  },
  {
    ...
    lastMessage: "I bumped your carbs to 200g - let me know how energy feels.",
  ...
  },
  {
    ...
    member: "Emma Wilson",
    topic: "Form check",
    lastMessage: "Your squat depth looks great. Keep bracing the core on the way up.",
    status: "Suggestion sent",
    time: "13:48",
  },
]

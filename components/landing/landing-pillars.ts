...
export const LANDING_PILLARS: readonly LandingPillar[] = [
  {
    ...
    imageAlt: "ZyntixAI members and client management dashboard",
    icon: Users,
  ...
  },
  {
    ...
    imageAlt: "ZyntixAI workout builder and exercise library",
    icon: BookOpen,
  ...
  },
  {
    ...
    imageAlt: "ZyntixAI progress tracking and weight trends",
    icon: BarChart3,
  ...
  },
  {
    ...
    imageAlt: "ZyntixAI coach command center dashboard",
  ...
  },
  {
    ...
    imageAlt: "ZyntixAI marketing content calendar and ideas",
    icon: Sparkles,
